...
**Important:** This container requires NVIDIA GPU support via the NVIDIA Container Toolkit.

#### Prerequisites

Install the NVIDIA Container Toolkit (required for GPU access):
...
2. Run the container with GPU support:
   ...
   The `--gpus all` flag automatically provides access to `nvidia-smi` and all required NVIDIA libraries.
